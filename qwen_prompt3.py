...
Let's think step by step. To perform the task, you should first analyze the logical part structure (lower level) and then identify logical structure. Several examples are given as follows.
...
def main():
    ...
    for test in test_files:
        ...
        output_file = f"output/{MODEL_NAME}/{test}.txt"
        print(len(test_data))
